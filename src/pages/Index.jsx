...
import { Container, VStack, HStack, Button, Box, Text, StackDivider, Heading, Flex, Link } from "@chakra-ui/react";
      ...
      <VStack spacing={8} w="full">
        ...
        <VStack spacing={4} divider={<StackDivider borderColor="gray.200" />} w="full">
          {filteredJobs.map(job => (
            <Box key={job.id} p={6} borderWidth="1px" borderRadius="lg" w="full" bg="white" boxShadow="lg" _hover={{ bg: "gray.50" }}>
              <Text fontSize="2xl" fontWeight="bold" mb={2}>{job.title}</Text>
        ...
        <Flex as="footer" w="full" py={4} justifyContent="center" borderTopWidth="1px" borderColor="gray.200">
          <Text fontSize="sm" color="gray.500">© 2023 Remote Tech Jobs. All rights reserved. | <Link href="#" color="blue.500">Privacy Policy</Link> | <Link href="#" color="blue.500">Terms of Service</Link></Text>
        </Flex>
      </VStack>
    </Container>
  );
